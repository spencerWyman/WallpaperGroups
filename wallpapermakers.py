...
star_442 = reflection_combiner(build_diagonal_2reflection(im))
blue_442 = translation_combiner(build_4gyration(im, quarter='r'))
star_2222 = reflection_combiner(build_vertical_2reflection(im, half='r'))
blue_2222 = translation_combiner(build_2gyration(im))
wandering = translation_combiner(im)
star_cross = translation_combiner(build_diagonal_2reflection(im))
star_star = translation_combiner(build_vertical_2reflection(im, half='l'))
blue4_star2 = reflection_combiner(build_4gyration(im, quarter='l'))
cross_cross = star_combiner(im.resize((100, 100)))
blue22_star = star_combiner(build_2gyration(im))
blue22_cross = reflection_diagonal_combiner(build_diagonal_2gyration(im))
blue2_star22 = reflection_combiner(build_2gyration(im))
star_632 = reflection_combiner(build_6reflection(im))
